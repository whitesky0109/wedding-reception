    ...
    <>
      ...
      <LazyDiv className="card location">
        ...
        <div className="location-info">
          ...
          <div className="heading">시내버스</div>
          <div />
          <div className="content">
            <li>
              역전정류장 : <b>13-1, 92-1</b>
        ...
        <div className="location-info">
          ...
          <div className="heading">시외버스</div>
          <div />
          <div className="content">
            <li>
              <b>강남역 7번출구, 양재역 7번출구</b>
              <br />- <b>3007번</b> : 매탄주공4단지, 매탄1동주민센터 하차 후 81번 버스 환승
              <br />→ 수원시청역10번출구, 경인일보 하차
              <br />- <b>3002번</b> : 수원시청역8번출구, 씨네파크 하차
            </li>
            <li>
              <b>사당역 4번출구</b>
              <br />- <b>7000번</b> : 구)법원사거리 하차 후 81번 환승
              <br />→ 수원시청역10번출구, 경인일보 하차
              <br />- <b>7001번</b> : 매탄1동주민센터 하차 후 81번 환승
              <br />→ 수원시청역10번출구, 경인일보 하차
            </li>
            <li>
              <b>잠실역</b>
              <br />- <b>M5342</b> : 망포역 4번출구 하차 후 61번
              <br />→ 수원시청역10번출구, 경인일보 하차
            </li>
            <li>
              <b>서현역(ak프라자)</b>
              <br />- <b>4000번</b> : 수원시청역8번출구, 씨네파크 하차
            </li>
          </div>
        </div>
      </LazyDiv>
